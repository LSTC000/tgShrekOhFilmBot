...
from data.messages import (
    ...
    SOCIAL_TIK_TOK_SHREK_OH_FILM_CHANNEL_URL_IKB_MESSAGE,
    SOCIAL_TIK_TOK_LSTC_CHANNEL_URL_IKB_MESSAGE,
    SOCIAL_OFFICIAL_TG_GROUP_IKB_MESSAGE
)

from data.urls import TIK_TOK_SHREK_OH_FILM_CHANNEL_URL, TIK_TOK_LSTC_CHANNEL_URL, OFFICIAL_GROUP_URL
...
def social_ikb() -> InlineKeyboardMarkup:
    ...
    ikb.row(InlineKeyboardButton(
        text=SOCIAL_TIK_TOK_SHREK_OH_FILM_CHANNEL_URL_IKB_MESSAGE,
        url=TIK_TOK_SHREK_OH_FILM_CHANNEL_URL)
    )
    ikb.row(InlineKeyboardButton(
        text=SOCIAL_TIK_TOK_LSTC_CHANNEL_URL_IKB_MESSAGE,
        url=TIK_TOK_LSTC_CHANNEL_URL)
    )
