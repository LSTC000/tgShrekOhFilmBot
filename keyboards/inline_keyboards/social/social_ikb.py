...
from data.urls import TIK_TOK_SHREK_OH_FILM_CHANNEL_URL, OFFICIAL_GROUP_URL
...
def social_ikb() -> InlineKeyboardMarkup:
    ...
    ikb.row(InlineKeyboardButton(text=SOCIAL_TIK_TOK_SHREK_OH_FILM_CHANNEL_URL_IKB_MESSAGE, url=TIK_TOK_SHREK_OH_FILM_CHANNEL_URL))
